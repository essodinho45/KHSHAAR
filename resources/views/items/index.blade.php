                    ...
                    <div class="min-w-full align-middle">
                        <table class="min-w-full border divide-y divide-gray-200 dark:divide-gray-700 dark:border-gray-700">
                            ...
                            <tr>
                                ...
                                <th class="bg-gray-50 dark:bg-gray-950 px-6 py-3 text-start">
                                    <span class="text-xs font-medium uppercase leading-4 tracking-wider text-gray-500">{{ __('sub_category') }}</span>
                                </th>
                                ...
                                @foreach($items as $item)
                                    <tr class="bg-white dark:bg-gray-800">
                                        ...
                                        <td class="px-6 py-4 text-sm leading-5 text-gray-900 dark:text-gray-100 whitespace-no-wrap">
                                            ...
                                            <form action="{{ route('items.destroy', $item) }}" method="POST" onsubmit="return confirm('{{ __('are_you_sure') }}')" style="display: inline-block;">
                                                @csrf
                                                @method('DELETE')
                                                <x-danger-button>
                                                    {{ __('delete') }}
